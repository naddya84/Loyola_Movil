    ...
    override fun onCreateView(
            ...
            {jsonObject->
                ...
                if(status == false) {
                    ...
                    for (i in 0 until dataPlanePay.length()) {
                        ...
                        plaso.text = dataPlanePay.getJSONObject(i).get("credPlazo").toString()
        ...
        btnGenerarPdf.setOnClickListener {
            ...
            if (ContextCompat.checkSelfPermission(context as Activity, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED) {
                ...
                val urlDowload = "${getString(R.string.host_service)}services/generate_pdf_plan_pagos.php?docu-cage=${user!!.id_member}&cred-number=${number}"
